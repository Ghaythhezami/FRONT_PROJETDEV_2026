...
@Component({
  ...
  template: `
    <article
      draggable="true"
      class="group cursor-grab rounded-2xl border border-gray-200/80 bg-white p-4 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md active:cursor-grabbing dark:border-white/[0.08] dark:bg-gray-900"
    ...
    >
      <div class="mb-3 flex items-start justify-between gap-2">
        ...
        <button
          type="button"
          class="rounded-md p-1 text-gray-400 opacity-0 transition group-hover:opacity-100 hover:bg-gray-100 hover:text-gray-600"
      ...
      <a
        ...
        [state]="{ issue: issue }"
        class="block text-sm font-semibold leading-snug text-gray-900 hover:text-brand-600 dark:text-white/90"
